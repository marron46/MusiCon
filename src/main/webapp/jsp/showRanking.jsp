...
<%-- cssの連携 --%>
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/showRanking.css">
</head>
<body>
	<div class="reverse">
	...
	<div class="container">
		...
		<ul>
			...
			%>
			<li>タイトル：<a href="${pageContext.request.contextPath}/PlayMusic?id=<%=m.getId()%>"> <%=m.getTitle()%></a><br>
